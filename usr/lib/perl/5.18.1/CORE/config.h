...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Fri Dec  6 18:38:05 UTC 2013
 * Configured by     : Debian Project
 * Target system     : linux estella 3.11-2-amd64 #1 smp debian 3.11.8-1 (2013-11-13) x86_64 gnulinux 
 */
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/perl/5.18.1"		/**/
#define SITEARCH_EXP "/usr/local/lib/perl/5.18.1"		/**/
 ...
 */
#define SITELIB "/usr/local/share/perl/5.18.1"		/**/
#define SITELIB_EXP "/usr/local/share/perl/5.18.1"		/**/
#define SITELIB_STEM ""		/**/
