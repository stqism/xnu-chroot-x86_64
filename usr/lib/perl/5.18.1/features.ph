...
unless(defined(&_FEATURES_H)) {
    ...
    if(defined (&_BSD_SOURCE)  && !(defined (&_POSIX_SOURCE) || defined (&_POSIX_C_SOURCE) || defined (&_XOPEN_SOURCE) || defined (&_GNU_SOURCE) || defined (&_SVID_SOURCE))) {
    ...
    if((!defined (&__STRICT_ANSI__)  && !defined (&_ISOC99_SOURCE)  && !defined (&_POSIX_SOURCE)  && !defined (&_POSIX_C_SOURCE)  && !defined (&_XOPEN_SOURCE)  && !defined (&_BSD_SOURCE)  && !defined (&_SVID_SOURCE))) {
	eval 'sub _BSD_SOURCE () {1;}' unless defined(&_BSD_SOURCE);
	eval 'sub _SVID_SOURCE () {1;}' unless defined(&_SVID_SOURCE);
    }
    ...
    eval 'sub __GLIBC_MINOR__ () {17;}' unless defined(&__GLIBC_MINOR__);
